      ...
      <div class="module-dash">
        ...
        @if (dashboard; as d) {
          ...
          <section class="module-dash-breakdowns">
            ...
            <app-dashboard-breakdown title="Alertas administrativas" subtitle="Contraseñas, inactividad y bloqueos" unit="alertas" [items]="alertas(d)" [colors]="alertColors" />
          </section>

          <section class="module-dash-operations">
            <article class="module-dash-highlight"><strong>{{ d.totalPasswordsVencidas + d.totalCuentasInactivas + d.totalCuentasBloqueadas }}</strong><span>Alertas de cuentas por resolver.</span></article>
...
export class UsuariosRedDashboardComponent implements OnInit {
  ...
  readonly alertColors = ['#c39b3f', '#5b8d9b', '#bd665b'];
  ...
  alertas(d: ActiveDirectoryDashboardCompleto): DashboardBreakdownItem[] { return [{ label: 'Contraseñas vencidas', total: d.totalPasswordsVencidas }, { label: 'Cuentas inactivas', total: d.totalCuentasInactivas }, { label: 'Cuentas bloqueadas', total: d.totalCuentasBloqueadas }]; }
