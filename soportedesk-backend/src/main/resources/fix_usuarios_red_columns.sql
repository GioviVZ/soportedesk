...
;WITH esperado (tabla, columna) AS (
    SELECT * FROM (VALUES
        ...
        ('impresoras','id'),('impresoras','marca'),('impresoras','modelo'),('impresoras','tipo_impresora_id'),
        ('impresoras','serie'),('impresoras','codigo_inventario'),('impresoras','codigo_patrimonial'),('impresoras','tipo_conexion'),('impresoras','ip'),
